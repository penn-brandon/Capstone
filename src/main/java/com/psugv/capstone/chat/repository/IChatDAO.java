...
public interface IChatDAO {
    ...
    void updateChatRoomName(UserModel userModel, Boolean admin, Integer chatRoomId, String name, Integer id);
    ...
    ChatRoomToUser findChatRoomToUserByUserId(Integer chatRoomId, Integer userId);
}
